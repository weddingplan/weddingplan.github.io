...
require.register("viewport-units-buggyfill/viewport-units-buggyfill.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "viewport-units-buggyfill");
  (function() {
    /*!
...
//https://raw.githubusercontent.com/PaulSpr/jQuery-Flex-Vertical-Center/master/jquery.flexverticalcenter.js
...
function show_stage() {
	...
	(0, _jquery2.default)("span.running-total").html("Total: $" + random);
	if (stage > maxStage) {
		maxStage = stage;
	}
	(0, _jquery2.default)('div.question').hide();
	reset_all_images();
	(0, _jquery2.default)('div#panel_' + stage)
	// .flexVerticalCenter()
	.show();
}
...
require.register("js/jquery.flexverticalcenter.js", function(exports, require, module) {
"use strict";
...
require.alias("viewport-units-buggyfill/viewport-units-buggyfill.js", "viewport-units-buggyfill");process = require('process');require.register("___globals___", function(exports, require, module) {
